        ...
        <div className="flex flex-col min-h-screen">
            ...
            <header className="backdrop-blur-md absolute top-0 left-0 right-0 z-50 w-full bg-transparent">
                <div className="container mx-auto px-4 h-24 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        <a href="#contact" className="text-xl font-bold text-white md:text-black hover:text-accent transition-colors drop-shadow-md md:drop-shadow-none">צור קשר</a>
                        ...
                        <a href="#faq" className="text-xl font-bold text-white md:text-black hover:text-accent transition-colors drop-shadow-md md:drop-shadow-none">שאלות נפוצות</a>
                    </div>
            ...
            <main className="flex-1">
                ...
                <section className="relative h-screen w-full overflow-hidden bg-white flex flex-col items-center justify-center pt-24">
                    ...
                    <div className="relative z-10 max-w-5xl text-center px-4 mb-22">
                        <h1 className="ml11">
                            <span className="text-wrapper">
                                <span className="line line1"></span>
                                <span className="letters">חופשה ירושלמית עם נוף עוצר נשימה</span>
                            </span>
                        </h1>
                    </div>
                    ...
                    <div className="carousel-viewport" ref={viewportRef}>
                        <div className="carousel-cylinder" ref={cylinderRef}>
                            {galleryImages.map((src, i) => (
                                <div key={i} className="carousel-item" data-i={i + 1}>
                                    <Image src={src} alt={`Image ${i + 1}`} fill className="object-cover" />
                                    <div className="item-label">
                                        <span>{String(i + 1).padStart(2, '0')}</span>
                                        <span>Tan Tan View</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="space-y-10">
                                <h2 className="text-6xl font-suez">החופשה השקטה שלכם</h2>
                                <div className="space-y-8">
                                    <div className="flex gap-6 items-start">
                                        <div>
                                            <h4 className="text-3xl font-suez mb-2">פרטיות מוחלטת</h4>
                                            <p className="text-xl text-neutral-500 font-varela">הסוויטה ממוקמת באזור שקט ומבודד, מבטיחה לכם פרטיות מלאה לאורך כל השהות.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-6 items-start">
                                        <div>
                                            <h4 className="text-3xl font-suez mb-2">ניקיון ללא פשרות</h4>
